...
### 프로젝트 정보
- **프로젝트명**: Kunnective (건국대 자율 협업 플랫폼)
- **목표**: 건국대학교 학생들의 아이디어 공유, 팀원 매칭, 프로젝트 협업을 위한 플랫폼
- **철학**: 자율성 - 역할 제한 없이 누구든 무엇이든 할 수 있습니다
- **대상 사용자**: 건국대학교 재학생 (@konkuk.ac.kr, @kku.ac.kr 이메일 보유자)
- **플랫폼**: 웹 + 모바일 멀티플랫폼
- **개발 형태**: 1인 개발 (AI 지원)
- **예산**: 무료 티어 우선 사용
...
### Phase 1: 인증 & 프로필 (1주)
- [x] Supabase Auth 연동
- [x] 회원가입 페이지 (건국대 이메일 검증)
- [x] 로그인/로그아웃
- [x] 프로필 생성 페이지
- [x] 프로필 수정 페이지
- [x] 프로필 조회 페이지
- [x] 이미지 업로드 기능
- [x] Protected routes 설정

### Phase 2: 아이디어 게시판 (1-2주)
- [x] 데이터베이스 스키마 생성 (ideas, likes, bookmarks)
- [x] 아이디어 목록 페이지 (무한 스크롤)
- [x] 아이디어 상세 페이지
- [x] 아이디어 작성 페이지 (Markdown 에디터)
- [x] 아이디어 수정/삭제
- [x] 좋아요 기능
- [x] 북마크 기능
- [x] 검색 기능
...
- [x] 데이터베이스 스키마 (projects, applications, scouts, members)
- [x] 프로젝트 생성 페이지
- [x] 프로젝트 목록 페이지
- [x] 프로젝트 상세 페이지
- [x] 지원하기 기능
- [x] 지원서 관리 (프로젝트 owner)
- [x] 스카웃 기능 (데이터베이스 준비 완료)
- [x] 팀원 수락/거절
- [x] 프로젝트 멤버 관리
