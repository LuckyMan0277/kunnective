# KU-Connect (건국대 아이디어 공유 & 팀 빌딩 플랫폼)
...
**총 코드 라인**: 7,770줄 | **총 커밋**: 16개 | **총 파일**: 48개

## 📌 프로젝트 소개

KU-Connect는 건국대학교 학생들이 자신의 아이디어를 공유하고, 함께할 팀원을 찾아 프로젝트를 시작할 수 있는 플랫폼입니다. 혼자서는 실현하기 어려운 아이디어도 적합한 팀원을 만나면 멋진 프로젝트가 될 수 있습니다.

### 주요 기능

- 🎯 **아이디어 게시판**: 아이디어를 자유롭게 공유하고 피드백 받기
- 👥 **팀원 매칭**: 프로젝트에 필요한 역할과 기술 스택을 명시하여 팀원 모집
- 📝 **지원 시스템**: 관심있는 프로젝트에 지원하거나 스카웃 제안 받기
- 💬 **실시간 채팅**: 1:1 메시징 및 프로젝트 팀 그룹 채팅
- 🔔 **알림 시스템**: 지원 결과, 스카웃 제안, 새 메시지 등 실시간 알림
- 👤 **프로필 관리**: 기술 스택, 관심 분야, 포트폴리오를 등록하여 나를 표현
